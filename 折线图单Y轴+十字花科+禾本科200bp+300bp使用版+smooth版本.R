...
##十字花科5utr单碱基位点保守性
bmp(file ="At5utr200bp6braTE14492单个位点保守性折线图smooth.bmp",width =1000*1,height = 750*1,units = "px",res =72*2)
...
p1<-ggplot(df1,aes(x=position,y=value,col=var))+
  ...
  geom_xspline(size=0.8,spline_shape = 2)+
  theme_classic()+
  #theme_bw()+# theme_dark()+
  ...
  theme(
    ...
    # axis.text.x=element_text(size=11,colour = "black",family="serif"),
    ...
    axis.title.y = element_text(size=12,color = "black",hjust = 0.5,vjust = 0.1,family="serif",face="bold"),
...
bmp(file ="At5utr200bp6braTE14492单个位点BPP折线图smooth.bmp",width =1000*1,height = 750*1,units = "px",res =72*2)
...
bmp(file ="At3utr200bp6braTE16852单个位点保守性折线图smooth.bmp",width =1000*1,height = 750*1,units = "px",res =72*2)
...
bmp(file ="At3utr200bp6braTE16852BPP保守性折线图smooth.bmp",width =1000*1,height = 750*1,units = "px",res =72*2)
...
library (ggplot2)
library(RColorBrewer)
bmp(file ="At3utr300bp6bra16815单个位点保守性折线图smooth.bmp",width =1000*1,height = 750*1,units = "px",res =72*2)
...
bmp(file ="At3utr300bp6bra16815BPP保守性折线图smooth.bmp",width =1000*1,height = 750*1,units = "px",res =72*2)
...
bmp(file ="Os5utr200bp6bra10543单个位点保守性折线图smooth.bmp",width =1000*1,height = 750*1,units = "px",res =72*2)
...
#禾本科5utr单碱基位点BPP
bmp(file ="Os5utr200bp6bra10543单个位点BPP折线图smooth.bmp",width =1000*1,height = 750*1,units = "px",res =72*2)
...
bmp(file ="Os3utr200bp6gra10534单个位点保守性折线图smooth.bmp",width =1000*1,height = 750*1,units = "px",res =72*2)
...
bmp(file ="Os3utr200bp6gra10534BPP保守性折线图smooth.bmp",width =1000*1,height = 750*1,units = "px",res =72*2)
...
library (ggplot2)
library(RColorBrewer)
bmp(file ="Os3utr300bp6gra10539单个位点保守性折线图smooth.bmp",width =1000*1,height = 750*1,units = "px",res =72*2)
...
bmp(file ="Os3utr300bp6gra10539BPP保守性折线图smooth.bmp",width =1000*1,height = 750*1,units = "px",res =72*2)
