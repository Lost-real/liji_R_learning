...
windowsFonts()
pdf(file ="boxplot十字花科中17物种ge6物种同源和非同源.pdf",width =600*2,height = 600*3)
# bmp(file ="boxplot十字花科中17物种ge6物种同源和非同源.bmp",width =600*2,height = 600*3,units = "px",res =72*2)
...
#panel.grid.minor用来去掉背景中小的网格
    ...
    #去除边框
    guides(fill="none")
    # geom_text(aes(1,3),label="liji",family="TT")
