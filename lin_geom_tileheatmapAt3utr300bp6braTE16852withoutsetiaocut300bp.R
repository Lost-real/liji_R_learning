...
library (ggplot2)
#library(tidyverse)
bmp(file ="At3utr300bp6bra16815out1merge1sortedreplacefillupcut300bpzhuanzhi-1.bmp",width =600*3,height = 750*3,units = "px",res =72*2)
df<- read.csv("At3utr300bp6bra16815out1merge1sortedreplacefillupcut300bpzhuanzhi-1.csv")
