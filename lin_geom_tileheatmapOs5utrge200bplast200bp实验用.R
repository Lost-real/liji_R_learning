...
#library(aplot)
#library(tidyverse)
bmp(file ="Os5utrlast200bpout1merge1sortedreplacefillupzhuanzhi-1.bmp",width =600*3,height = 750*3,units = "px",res =72*4)
df<- read.csv("Os5utrlast200bpout1merge1sortedreplacefillupzhuanzhi-1.csv")
...
theme_void()+
  ...
  scale_x_continuous(breaks=c(80,180,280,380,480,579),
 ...
 # labs(x=" ",y=" ")+
  ...
  theme(
        ...
        legend.title = element_text(color = "black", size = 5,vjust=2),#vjust越大越上
