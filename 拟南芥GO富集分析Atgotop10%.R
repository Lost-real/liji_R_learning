...
genelist<- read.table("At14492top10%.txt",header = T)
...
# head(Atgo_bp)
write.table(Atgo_bp,file="At14492top10%gobp.txt",sep="\t")
...
# head(Atgo_mf)
write.table(Atgo_mf,file="At14492top10%gomf.txt",sep="\t")
...
# head(Atgo_cc)
write.table(Atgo_cc,file="At14492top10%gocc.txt",sep="\t") 
