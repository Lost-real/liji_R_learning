...
# library(aplot)
#library(tidyverse)
bmp(file ="At5utr200bp6braTE14492merge1sortedreplacefillupreversecut200bpzhuanzhi-1.bmp",width =600*3,height = 750*3,units = "px",res =72*2)
...
#pivot_longer(df)
cols <- colorRampPalette(c("tan1","dodgerblue2"))(1200)
