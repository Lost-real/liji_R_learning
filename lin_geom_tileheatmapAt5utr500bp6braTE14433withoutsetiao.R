...
# library(aplot)
#library(tidyverse)
bmp(file ="At5utr500bp6bra14433merge1sortedreplacefillupreversezhuanzhi-1.bmp",width =600*3,height = 750*3,units = "px",res =72*2)
df<- read.csv("At5utr500bp6bra14433merge1sortedreplacefillupreversezhuanzhi-1.csv")
...
ggplot(df,aes(x,y,fill=conservation))+geom_tile(width=1,height=1)+
  ...
  scale_x_continuous(breaks=c(21,221,421,621,821,1021,1220),
  labels=c("-1200","-1000","-800","-600","-400","-200","-1"))+
  labs(x=" ",y=" ")+
