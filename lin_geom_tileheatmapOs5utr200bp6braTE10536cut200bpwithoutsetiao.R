...
library (ggplot2)
#library(tidyverse)
bmp(file ="Os5utr200bpout1merge1sortedreplacefillupreversecut200bpzhuanzhi-1.bmp",width =600*3,height = 750*3,units = "px",res =72*2)
df<- read.csv("Os5utr200bpout1merge1sortedreplacefillupreversecut200bpzhuanzhi-1.csv")
