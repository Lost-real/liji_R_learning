...
# library(aplot)
#library(tidyverse)
bmp(file ="Os3utr300bp10539out1merge1sortedreplacefillupzhuanzhi-1.bmp",width =600*3,height = 750*3,units = "px",res =72*2)
df<- read.csv("Os3utr300bp10539out1merge1sortedreplacefillupzhuanzhi-1.csv")
