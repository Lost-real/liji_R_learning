...
library(aplot)
#library(tidyverse)
bmp(file ="At3utr200bp6bra16852merge1sortedreplacefillupcut200bpzhuanzhi-1.bmp",width =600*3,height = 750*3,units = "px",res =72*2)
df<- read.csv("At3utr200bp6bra16852merge1sortedreplacefillupcut200bpzhuanzhi-1.csv")
