...
# library(aplot)
#library(tidyverse)
bmp(file ="Os3utr200bp10543out1merge1sortedreplacefillupcut200bpzhuanzhi-1.bmp",width =600*3,height = 750*3,units = "px",res =72*2)
df<- read.csv("Os3utr200bp10543out1merge1sortedreplacefillupcut200bpzhuanzhi-1.csv")
