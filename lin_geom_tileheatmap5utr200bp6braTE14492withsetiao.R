...
library(aplot)
#library(tidyverse)
bmp(file ="At5utr200bp6braTE14492merge1sortedreplacefillupreversezhuanzhi-3.bmp",width =600*3,height = 750*3,units = "px",res =72*2)
df<- read.csv("At5utr200bp6braTE14492merge1sortedreplacefillupreversezhuanzhi-1.csv")
...
##000000最黑，#FF0000最红
scale_fill_manual(values = c("#000000","#2E2E2E","#787878","#B9B9B9","#D28181","#FF0000"))+
