...
# library(aplot)
#library(tidyverse)
bmp(file ="At5utrge200bp6braTE3614merge1sortedreplacefillupreversecut200bpzhuanzhi-2.bmp",width =600*3,height = 750*3,units = "px",res =72*2)
df<- read.csv("At5utrge200bp6braTE3614merge1sortedreplacefillupreversecut200bpzhuanzhi-1.csv")
