...
library (ggplot2)
bmp(file ="3UTR300bp+AT1G14020.1.fasta123zhuanzhi-1.bmp",width =900*3,height = 65*3,units = "px",res =72*3)
df<- read.csv("3UTR300bp+AT1G14020.1.fasta123zhuanzhi-1.csv")
...
library(RColorBrewer)
library (ggplot2)
bmp(file ="3UTR300bp+AT1G76390.1.fasta123zhuanzhi-1.bmp",width =900*3,height = 65*3,units = "px",res =72*3)
df<- read.csv("3UTR300bp+AT1G76390.1.fasta123zhuanzhi-1.csv")
df$y<-factor(df$y,levels=rev(unique(df$y)))
#df$y%>%factor()%>%fct_inorder()
#pivot_longer(df)
cols <- colorRampPalette(c("dodgerblue2","darkorange2"))(1200)
...
library(RColorBrewer)
library (ggplot2)
bmp(file ="3UTR300bp+AT4G03220.1.fasta123zhuanzhi-1.bmp",width =900*3,height = 65*3,units = "px",res =72*3)
df<- read.csv("3UTR300bp+AT4G03220.1.fasta123zhuanzhi-1.csv")
df$y<-factor(df$y,levels=rev(unique(df$y)))
#df$y%>%factor()%>%fct_inorder()
#pivot_longer(df)
cols <- colorRampPalette(c("dodgerblue2","darkorange2"))(1200)
...
library(RColorBrewer)
library (ggplot2)
bmp(file ="3UTR300bp+AT5G56450.1.fasta123zhuanzhi-1.bmp",width =900*3,height = 65*3,units = "px",res =72*3)
df<- read.csv("3UTR300bp+AT5G56450.1.fasta123zhuanzhi-1.csv")
df$y<-factor(df$y,levels=rev(unique(df$y)))
#df$y%>%factor()%>%fct_inorder()
#pivot_longer(df)
cols <- colorRampPalette(c("dodgerblue2","darkorange2"))(1200)
...
library(RColorBrewer)
library (ggplot2)
bmp(file ="3UTR300bp+LOC_Os12g13170.2.fasta123zhuanzhi-1.bmp",width =600*3,height = 65*3,units = "px",res =72*3)
df<- read.csv("3UTR300bp+LOC_Os12g13170.2.fasta123zhuanzhi-1.csv")
df$y<-factor(df$y,levels=rev(unique(df$y)))
#df$y%>%factor()%>%fct_inorder()
#pivot_longer(df)
cols <- colorRampPalette(c("dodgerblue2","darkorange2"))(1200)
...
library(RColorBrewer)
library (ggplot2)
bmp(file ="3UTR300bp+LOC_Os01g57942.1.fasta123zhuanzhi-1.bmp",width =600*3,height = 65*3,units = "px",res =72*3)
df<- read.csv("3UTR300bp+LOC_Os01g57942.1.fasta123zhuanzhi-1.csv")
df$y<-factor(df$y,levels=rev(unique(df$y)))
#df$y%>%factor()%>%fct_inorder()
#pivot_longer(df)
cols <- colorRampPalette(c("dodgerblue2","darkorange2"))(1200)
...
library(RColorBrewer)
library (ggplot2)
bmp(file ="3UTR300bp+LOC_Os01g58022.1.fasta123zhuanzhi-1.bmp",width =600*3,height = 65*3,units = "px",res =72*3)
df<- read.csv("3UTR300bp+LOC_Os01g58022.1.fasta123zhuanzhi-1.csv")
df$y<-factor(df$y,levels=rev(unique(df$y)))
#df$y%>%factor()%>%fct_inorder()
#pivot_longer(df)
cols <- colorRampPalette(c("dodgerblue2","darkorange2"))(1200)
...
library(RColorBrewer)
library (ggplot2)
bmp(file ="3UTR300bp+LOC_Os12g38110.1.fasta123zhuanzhi-1.bmp",width =600*3,height = 65*3,units = "px",res =72*3)
df<- read.csv("3UTR300bp+LOC_Os12g38110.1.fasta123zhuanzhi-1.csv")
df$y<-factor(df$y,levels=rev(unique(df$y)))
#df$y%>%factor()%>%fct_inorder()
#pivot_longer(df)
cols <- colorRampPalette(c("dodgerblue2","darkorange2"))(1200)
...
library(RColorBrewer)
library (ggplot2)
bmp(file ="3UTR300bp+LOC_Os06g39708.1.fasta123zhuanzhi-1.bmp",width =600*3,height = 65*3,units = "px",res =72*3)
df<- read.csv("3UTR300bp+LOC_Os06g39708.1.fasta123zhuanzhi-1.csv")
df$y<-factor(df$y,levels=rev(unique(df$y)))
#df$y%>%factor()%>%fct_inorder()
#pivot_longer(df)
cols <- colorRampPalette(c("dodgerblue2","darkorange2"))(1200)
